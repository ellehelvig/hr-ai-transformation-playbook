...
The high-risk rules for HR systems apply from **2 December 2027**, moved from August 2026 by the AI Omnibus (Regulation (EU) 2026/1744). It is a fixed date, so build the practice now. Vendors and customers are already asking for the evidence trail.

Some obligations are already live. Since 2 August 2026 you must tell people when they are dealing with an AI system and label AI-generated content, and breaches can be fined up to EUR 15 million or 3% of worldwide turnover. In obligation 9 below, the transparency part applies now; informing affected people under Article 26(11) waits for the high-risk date. See [Key dates for HR](README.md#key-dates-for-hr) for the full list.
