...
Other AI Act obligations follow their own timelines and are not affected by the same deferral. Two of them are already enforceable and easy to overlook while attention sits on 2027: the Article 50 transparency obligations applied from 2 August 2026 (the Omnibus did not move that date, though its recitals describe a transitional period for some content-marking duties, so confirm with counsel which apply to your systems), and the penalty provisions in Articles 99 and 101 became operative the same day. For breaches of operator obligations such as Article 50, the Article 99 tier reaches EUR 15 million or 3% of worldwide annual turnover, whichever is higher. If any HR use case generates or manipulates content, produces deepfakes, or does emotion recognition, that exposure is live today, not in December 2027.
