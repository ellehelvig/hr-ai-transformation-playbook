...
- **Colorado.** SB 24-205 was repealed and reenacted by SB 26-189 (May 2026) as the Automated Decision-Making Technology Act, effective 1 January 2027 with a narrower scope. Don't cite the old bill number or timeline. Enforcement of both bills is currently stayed: in April 2026 a federal court entered a stay the Attorney General agreed to, lasting until rulemaking is complete (due by 1 January 2027) and the court rules on xAI's constitutional challenge. Treat January 2027 as a compliance deadline, not a confirmed enforcement start, and check the docket before telling anyone this law is live.
- **California.** Two separate regimes, not one generic "CCPA" reference: the FEHA algorithmic discrimination rules (effective October 2025) and the CPPA ADMT regulations (effective January 2027). Two further bills, AB 1883 and SB 947, are pending the Governor's signature with a 30 September 2026 deadline, so don't score them as law yet.
