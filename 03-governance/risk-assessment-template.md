...
| Regulatory exposure | Minimal | Some (state AI laws, GDPR) | High (Title VII disparate impact, CCPA/CPPA ADMT, IL HB 3773, CO ADMT Act, TX TRAIGA, NJ LAD) |
| Autonomy level | Human-in-the-loop throughout | Human reviews AI output | AI acts autonomously |

**Overall risk rating:** [ ] Low  [ ] Medium  [ ] High

**Note on regulatory exposure.** Federal EEOC enforcement of AI-related disparate impact has been deprioritized since April 2025, but the underlying Title VII liability and private litigation risk have not changed, and state laws are getting more specific, not less. The practical shift is toward private suits. *Mobley v. Workday* is the case practitioners now cite as the template for AI hiring discrimination claims against vendors, not just employers. Score this row on legal exposure, not on how actively a federal agency is enforcing it and not on whether a state has passed something with "AI" in the title.

The [AI literacy curriculum's regulatory landscape module](../04-enablement/hr-ai-literacy-curriculum.md) has the current detail. The points that most often change a score:

- **Colorado.** SB 24-205 was repealed and reenacted by SB 26-189 (May 2026) as the Automated Decision-Making Technology Act, effective 1 January 2027 with a narrower scope. Don't cite the old bill number or timeline. Enforcement of both bills is currently stayed: in April 2026 a federal court stayed enforcement pending a ruling on xAI's constitutional challenge and completion of the AG's rulemaking (due by 1 January 2027). Treat January 2027 as a compliance deadline, not a confirmed enforcement start, and check the docket before telling anyone this law is live.
- **California.** Two separate regimes, not one generic "CCPA" reference: the FEHA algorithmic discrimination rules (effective October 2025) and the CPPA ADMT regulations (effective January 2027). Two further bills, AB 1883 and SB 947, passed the Legislature in 2026; their status has not been verified against the official bill history, so don't score them as law until it is.
- **Connecticut.** Public Act 26-15 raises this row's score for any Connecticut workforce as of 1 October 2026. From that date, using an automated employment-related decision technology is not a defense to a discrimination complaint under Conn. Gen. Stat. 46a-60, and the quality, recency, and scope of your anti-bias testing becomes evidence the commission or a court may weigh. That makes the fairness audit below a legal artifact in Connecticut, not just good practice.
- **Texas.** TRAIGA (HB 149) took effect 1 January 2026 and is narrower than Illinois or Colorado: it reaches intentional discrimination, not disparate impact. The AG's online complaint portal is live at texasattorneygeneral.gov. TRAIGA's disclosure and complaint provisions are scoped to "consumers," a term the statute defines to exclude someone "acting in a commercial or employment context," so lean on the separate intentional-discrimination prohibition for HR use cases.
- **New Jersey.** There is no AI statute, so it is easy to score as low exposure and wrong to. January 2025 guidance from the Attorney General and the Division on Civil Rights states that the Law Against Discrimination already reaches algorithmic discrimination, that a third-party tool is no defense, and that whether the employer tested for bias may be weighed as evidence.
