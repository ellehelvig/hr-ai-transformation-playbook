...
9. **GDPR Article 22 / DPIA touchpoint.** Is there solely automated decision-making with legal or similarly significant effect? If yes, Article 22 protections apply on top of AI Act duties, and they apply now, not in December 2027. Article 22 has been enforceable since May 2018, on its own timeline, independent of the AI Act. At a July 2026 Parliament conference, the EDPS and EDPB said explicitly that the Omnibus delay creates no GDPR safe harbor, and the EDPB's 2026 Coordinated Enforcement Framework (CNIL-coordinated, 25 national DPAs) is actively auditing AI hiring tools' transparency notices. Has a DPIA been completed or scheduled? Note also: under the CJEU's SCHUFA standard, a vendor whose score the employer "heavily relies on" can itself be the Article 22 controller, not just you. Confirm who owns that liability in the vendor contract, don't assume it's automatically yours alone.
