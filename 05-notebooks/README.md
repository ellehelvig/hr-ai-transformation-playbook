...
Notebook-style demo writeups for HR AI workflows: narrative walkthroughs with runnable code, read top to bottom or copied into an actual notebook. All examples use synthetic data. Never run them against real employee data without first reviewing the [risk assessment template](../03-governance/risk-assessment-template.md).
...
| [skills-gap-analysis.md](skills-gap-analysis.md) | Identify priority L&D investments by mapping employee skill assessments against a competency framework |

## Running locally

The code in each demo is runnable. Copy the cells into a Jupyter notebook or Python script.
