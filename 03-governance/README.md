...
Two things are enforceable today and get lost behind the 2027 headline: Article 50 transparency obligations applied from 2 August 2026 (the Omnibus did not move that date, though its recitals describe a transitional period for some content-marking duties, so confirm with counsel which apply to your systems), and the Article 99 and 101 penalty provisions became operative on the same date. Separately, the Commission's draft Guidelines on high-risk classification under Article 6 (published 19 May 2026, consultation closed 23 July 2026, final text expected around end of 2026) are the closest thing to an official reading of the Annex III point 4 employment categories. They are draft and non-binding. See the [EU AI Act intake template](eu-ai-act-intake-template.md) for both.
