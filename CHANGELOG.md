...
- **Key dates for HR** in `03-governance/README.md`: one table of every key legal date, what it means for HR, and a link to the official text, with a "Last reviewed" date. It replaces a claims registry, checker script, weekly source-check workflow, and hidden citation markers that were built during this cycle and never released. The registry verified that quotes still appeared in statutes, which cost more to maintain than it gave an HR reader. The dates it checked are all in the table. Review is manual and quarterly.
- **New Jersey coverage in the state law module and the risk assessment template.** New Jersey has no AI hiring statute, so a scan for AI-specific bills misses it entirely, which is exactly why it belongs in the curriculum. January 2025 guidance from the Attorney General and the Division on Civil Rights states that the Law Against Discrimination already reaches algorithmic discrimination in employment, that a third-party tool is no defense, and that whether the employer tested for bias may be weighed as evidence, the same pattern Connecticut creates by statute. The module states the two limits plainly: the guidance is interpretive and disclaims imposing anything beyond the LAD, and it carries no effective date because the statute has been in force for decades.

Fixed

- **EU AI Act penalties date.** The governance README, the intake template and the deployer checklist said the Article 99 and 101 penalty provisions both became operative on 2 August 2026. Article 99 sits in Chapter XII, which Article 113(b) of Regulation (EU) 2024/1689 applies from 2 August 2025; only Article 101 waits for 2 August 2026, and Regulation (EU) 2026/1744 leaves point (b) untouched. The practical point stands, since an Article 50 fine could not arise before Article 50 applied, but the regime was not new on that date.
