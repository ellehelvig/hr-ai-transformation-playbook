...
The high-risk rules for AI used in employment apply from **2 December 2027**, moved from August 2026 by the AI Omnibus (Regulation (EU) 2026/1744). It is a fixed date. Keep the classification field current now, because vendors and customers are already asking for the evidence trail.

The transparency rules are already live. Since 2 August 2026, if an HR use case chats with people, generates or manipulates content, produces deepfakes, or does emotion recognition, you must disclose it, and breaches can be fined up to EUR 15 million or 3% of worldwide turnover. That exposure is live today, not in December 2027. See [Key dates for HR](README.md#key-dates-for-hr) for the full list.
